...
4. Search for existing bookings using either the client’s name or email address.
...
##🏋️‍♂ Fitness Class Booking API (Django + Django REST Framework)
--------------
...
2. 🐍 Create Virtual Environment(If needed, But it Highly Recomended to create .venv to avoid
----------------
...
7. 📦 Example POST Request (Booking)
   ------------------------
